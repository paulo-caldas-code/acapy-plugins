...
AGENT = Agent(
        ...
        wallet_webhook_url="http://holder:3008/webhooks"
        )
CONNECTION_ID = None
...
class HolderWebHookHandler:
    ...
    async def handle_issue_credential_v2_0_anoncreds(self, message):
        if "cred_id_stored" in message:
            ...
            notify(prefix="CREDENTIAL", msg=f"Stored credential {credential_id} in wallet")
    ...
    async def handle_present_proof_v2_0(self, message):
        ...
        if state == "request-received":
            ...
            requested_attributes_obj = message["by_format"]["pres_request"]["anoncreds"]["requested_attributes"]
    ...
    async def entrypoint():
        menu = Menu(
                ...
                entries=[
                    ...
                    MenuEntry(key="4", description="Input new invitation", on_press=_receive_invitation),
                    ])
